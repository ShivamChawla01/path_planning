          ...
          // j[1] is the data JSON object
        	...
        	// Main car's localization Data
          	...
          	auto previous_path_x = j[1]["previous_path_x"];
						// std::cout<<previous_path_x.size()<<endl;
          	...
          	// TODO: define a path made up of (x,y) points that the car will visit sequentially every .02 seconds
						...
						// 	next_x_vals.push_back(car_x+(dist_inc*i)*cos(deg2rad(ref_yaw)));
						// 	next_y_vals.push_back(car_y+(dist_inc*i)*sin(deg2rad(ref_yaw)));
						// }
						// int r=next_x_vals.size();
						// std::cout<<next_x_vals[r-1]<<next_x_vals[r-2]<<next_x_vals[r-3]<<endl;
						json msgJson;
